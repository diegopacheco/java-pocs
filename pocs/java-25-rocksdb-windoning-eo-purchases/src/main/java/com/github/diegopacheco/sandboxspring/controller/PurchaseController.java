...
import com.github.diegopacheco.sandboxspring.service.PurchaseStorage;
import com.github.diegopacheco.sandboxspring.service.PurchaseProcessor;
...
public class PurchaseController {
    ...
    public PurchaseController(PurchaseStorage purchaseStorage, PurchaseProcessor purchaseProcessor) {
    ...
    public Map<String, Object> generate(@PathVariable int count, @PathVariable String id) {
        for (int i = 0; i < count; i++) {
            ...
            purchaseStorage.storePurchase(purchase);
        }
    ...
    public Map<String, Object> getTotal(@PathVariable String id) {
        BigDecimal total = purchaseProcessor.getTotalDebt(id);
        Map<String, Object> response = new HashMap<>();
        response.put("userId", id);
    ...
    public Map<String, Object> getHistory(@PathVariable String id) {
        List<Purchase> history = purchaseProcessor.getPurchaseHistory(id);
        Map<String, Object> response = new HashMap<>();
        response.put("userId", id);

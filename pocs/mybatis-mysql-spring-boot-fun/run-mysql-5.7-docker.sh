...
echo "CREATE DATABASE person_db;" | mysql -uroot -ppass -h127.0.0.1 -P3325

sleep 3
echo "Creating person table... "
echo "use person_db; CREATE TABLE IF NOT EXISTS person_db.person (
...
echo "use person_db; select * from person_db.person" | mysql -uroot -ppass -h127.0.0.1 -P3325
echo "DONE."
...
./mvnw spring-boot:run -Dspring-boot.run.agents="/home/diego/git/diegopacheco/java-pocs/pocs/springboot2-agent-logs/java-agent/target/java-agent-1.0-SNAPSHOT-jar-with-dependencies.jar,/home/diego/git/diegopacheco/java-pocs/pocs/springboot2-agent-logs/java-agent/target/java-agent-1.0-SNAPSHOT-jar-with-dependencies.jar"

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.873Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateVolumeRbd")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateVolumeRbd.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateVolumeRbd extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef> getSecretRef() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateVolumeRbd}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateVolumeRbd}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateVolumeRbd> {
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef> secretRef;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getCephMonitors}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getRbdImage}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getFsType}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getKeyring}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getRadosUser}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getRbdPool}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getReadOnly}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeRbd#getSecretRef}
         * @param secretRef secret_ref block.
         *                  Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#secret_ref ReplicationController#secret_ref}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder secretRef(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef> secretRef) {
            this.secretRef = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef>)secretRef;
            return this;
        }

        /**
         * Builds the configured instance.
         * @return a new instance of {@link ReplicationControllerSpecTemplateVolumeRbd}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateVolumeRbd build() {
            return new Jsii$Proxy(cephMonitors, rbdImage, fsType, keyring, radosUser, rbdPool, readOnly, secretRef);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateVolumeRbd}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateVolumeRbd {
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef> secretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.secretRef = software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef.class)));
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeRbdSecretRef> getSecretRef() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateVolumeRbd"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateVolumeRbd.Jsii$Proxy that = (ReplicationControllerSpecTemplateVolumeRbd.Jsii$Proxy) o;

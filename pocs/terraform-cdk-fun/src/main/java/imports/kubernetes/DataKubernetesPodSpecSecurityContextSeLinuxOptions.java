...
public class DataKubernetesPodSpecSecurityContextSeLinuxOptions extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecSecurityContextSeLinuxOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecSecurityContextSeLinuxOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

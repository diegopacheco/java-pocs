...
public class DataKubernetesPodSpecContainerLifecyclePostStartHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLifecyclePostStartHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLifecyclePostStartHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

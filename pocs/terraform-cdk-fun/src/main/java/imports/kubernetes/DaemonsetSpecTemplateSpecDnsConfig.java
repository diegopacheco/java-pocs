...
public interface DaemonsetSpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption> getOption() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecDnsConfig> {
        ...
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption> option;
        ...
        public Builder option(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption> option) {
            this.option = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption>)option;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecDnsConfig {
        ...
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption> option;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.option = software.amazon.jsii.Kernel.get(this, "option", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> nameservers, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption> option, final java.util.List<java.lang.String> searches) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecDnsConfigOption> getOption() {
            return this.option;
        }

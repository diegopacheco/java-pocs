...
public class DataKubernetesPodSpecInitContainerEnvFrom extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvFrom(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvFrom(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

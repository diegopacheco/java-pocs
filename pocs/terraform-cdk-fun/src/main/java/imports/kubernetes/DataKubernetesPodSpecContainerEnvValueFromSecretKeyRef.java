...
public class DataKubernetesPodSpecContainerEnvValueFromSecretKeyRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerEnvValueFromSecretKeyRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerEnvValueFromSecretKeyRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

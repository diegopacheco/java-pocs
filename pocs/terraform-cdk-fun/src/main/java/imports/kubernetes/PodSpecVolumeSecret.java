...
public interface PodSpecVolumeSecret extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecVolumeSecretItems> getItems() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecVolumeSecret> {
        ...
        private java.util.List<imports.kubernetes.PodSpecVolumeSecretItems> items;
        ...
        public Builder items(java.util.List<? extends imports.kubernetes.PodSpecVolumeSecretItems> items) {
            this.items = (java.util.List<imports.kubernetes.PodSpecVolumeSecretItems>)items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecVolumeSecret {
        ...
        private final java.util.List<imports.kubernetes.PodSpecVolumeSecretItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeSecretItems.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultMode, final java.util.List<? extends imports.kubernetes.PodSpecVolumeSecretItems> items, final java.lang.Boolean optional, final java.lang.String secretName) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecVolumeSecretItems> getItems() {
            return this.items;
        }

...
public interface PersistentVolumeClaimSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.PersistentVolumeClaimSpecResources> getResources();
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PersistentVolumeClaimSpecSelector> getSelector() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeClaimSpec> {
        ...
        private java.util.List<imports.kubernetes.PersistentVolumeClaimSpecResources> resources;
        private java.util.List<imports.kubernetes.PersistentVolumeClaimSpecSelector> selector;
        ...
        public Builder resources(java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpecResources> resources) {
            this.resources = (java.util.List<imports.kubernetes.PersistentVolumeClaimSpecResources>)resources;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder selector(java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpecSelector> selector) {
            this.selector = (java.util.List<imports.kubernetes.PersistentVolumeClaimSpecSelector>)selector;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeClaimSpec {
        ...
        private final java.util.List<imports.kubernetes.PersistentVolumeClaimSpecResources> resources;
        private final java.util.List<imports.kubernetes.PersistentVolumeClaimSpecSelector> selector;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.resources = software.amazon.jsii.Kernel.get(this, "resources", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PersistentVolumeClaimSpecResources.class)));
            this.selector = software.amazon.jsii.Kernel.get(this, "selector", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PersistentVolumeClaimSpecSelector.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> accessModes, final java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpecResources> resources, final java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpecSelector> selector, final java.lang.String storageClassName, final java.lang.String volumeName) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.accessModes = java.util.Objects.requireNonNull(accessModes, "accessModes is required");
            this.resources = (java.util.List<imports.kubernetes.PersistentVolumeClaimSpecResources>)java.util.Objects.requireNonNull(resources, "resources is required");
            this.selector = (java.util.List<imports.kubernetes.PersistentVolumeClaimSpecSelector>)selector;
            this.storageClassName = storageClassName;
            this.volumeName = volumeName;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.PersistentVolumeClaimSpecResources> getResources() {
            return this.resources;
        }

        @Override
        public final java.util.List<imports.kubernetes.PersistentVolumeClaimSpecSelector> getSelector() {

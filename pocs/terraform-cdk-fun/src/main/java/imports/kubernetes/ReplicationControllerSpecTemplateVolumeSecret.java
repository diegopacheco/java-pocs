...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.874Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateVolumeSecret")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateVolumeSecret.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateVolumeSecret extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems> getItems() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateVolumeSecret}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateVolumeSecret}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateVolumeSecret> {
        private java.lang.String defaultMode;
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems> items;
        private java.lang.Boolean optional;
        private java.lang.String secretName;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeSecret#getDefaultMode}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeSecret#getItems}
         * @param items items block.
         *              Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#items ReplicationController#items}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder items(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems> items) {
            this.items = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems>)items;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeSecret#getOptional}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeSecret#getSecretName}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateVolumeSecret}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateVolumeSecret build() {
            return new Jsii$Proxy(defaultMode, items, optional, secretName);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateVolumeSecret}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateVolumeSecret {
        private final java.lang.String defaultMode;
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultMode, final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems> items, final java.lang.Boolean optional, final java.lang.String secretName) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateVolumeSecretItems> getItems() {
            return this.items;
        }
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateVolumeSecret"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateVolumeSecret.Jsii$Proxy that = (ReplicationControllerSpecTemplateVolumeSecret.Jsii$Proxy) o;

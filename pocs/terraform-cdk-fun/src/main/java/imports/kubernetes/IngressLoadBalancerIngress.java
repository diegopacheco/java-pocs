...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.IngressLoadBalancerIngress")
public class IngressLoadBalancerIngress extends com.hashicorp.cdktf.ComplexComputedList {

    protected IngressLoadBalancerIngress(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected IngressLoadBalancerIngress(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public IngressLoadBalancerIngress(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String complexComputedListIndex) {

...
public interface StatefulSetSpecTemplateSpecVolumeCephFs extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef> getSecretRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecVolumeCephFs> {
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef> secretRef;
        ...
        public Builder secretRef(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef> secretRef) {
            this.secretRef = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef>)secretRef;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecVolumeCephFs {
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef> secretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.secretRef = software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> monitors, final java.lang.String path, final java.lang.Boolean readOnly, final java.lang.String secretFile, final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef> secretRef, final java.lang.String user) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeCephFsSecretRef> getSecretRef() {

...
public interface JobSpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecDnsConfigOption> getOption() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecDnsConfig> {
        ...
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecDnsConfigOption> option;
        ...
        public Builder option(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecDnsConfigOption> option) {
            this.option = (java.util.List<imports.kubernetes.JobSpecTemplateSpecDnsConfigOption>)option;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecDnsConfig {
        ...
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecDnsConfigOption> option;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.option = software.amazon.jsii.Kernel.get(this, "option", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecDnsConfigOption.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> nameservers, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecDnsConfigOption> option, final java.util.List<java.lang.String> searches) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecDnsConfigOption> getOption() {
            return this.option;
        }

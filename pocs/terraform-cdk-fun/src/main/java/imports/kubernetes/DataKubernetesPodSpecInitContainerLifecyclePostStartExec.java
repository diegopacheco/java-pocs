...
public class DataKubernetesPodSpecInitContainerLifecyclePostStartExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLifecyclePostStartExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLifecyclePostStartExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

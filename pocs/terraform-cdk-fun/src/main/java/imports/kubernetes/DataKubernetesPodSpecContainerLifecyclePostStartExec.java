...
public class DataKubernetesPodSpecContainerLifecyclePostStartExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLifecyclePostStartExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLifecyclePostStartExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.807Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateSecurityContext.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSecurityContext> {
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions> seLinuxOptions;
        private java.util.List<java.lang.Number> supplementalGroups;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSecurityContext#getFsGroup}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#se_linux_options ReplicationController#se_linux_options}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateSecurityContext#getSupplementalGroups}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateSecurityContext build() {
            return new Jsii$Proxy(fsGroup, runAsGroup, runAsNonRoot, runAsUser, seLinuxOptions, supplementalGroups);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSecurityContext {
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions.class)));
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateSecurityContext.Jsii$Proxy that = (ReplicationControllerSpecTemplateSecurityContext.Jsii$Proxy) o;

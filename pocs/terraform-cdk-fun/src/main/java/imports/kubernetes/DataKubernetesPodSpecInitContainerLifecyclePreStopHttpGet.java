...
public class DataKubernetesPodSpecInitContainerLifecyclePreStopHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLifecyclePreStopHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLifecyclePreStopHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

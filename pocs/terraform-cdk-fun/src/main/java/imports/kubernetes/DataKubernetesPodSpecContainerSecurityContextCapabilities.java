...
public class DataKubernetesPodSpecContainerSecurityContextCapabilities extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerSecurityContextCapabilities(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerSecurityContextCapabilities(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

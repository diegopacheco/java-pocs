...
public class DataKubernetesPodSpecContainerLifecyclePreStopHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLifecyclePreStopHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLifecyclePreStopHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public interface ReplicationControllerSpecTemplateSpecContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities> getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecContainerSecurityContext> {
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities> capabilities;
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        public Builder capabilities(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities> capabilities) {
            this.capabilities = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities>)capabilities;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecContainerSecurityContext {
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities> capabilities;
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities.class)));
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions.class)));
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextCapabilities> getCapabilities() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {

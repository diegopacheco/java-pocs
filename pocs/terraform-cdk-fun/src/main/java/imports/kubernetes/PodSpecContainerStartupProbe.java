...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.727Z")
...
public interface PodSpecContainerStartupProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecContainerStartupProbeExec> getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecContainerStartupProbeHttpGet> getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecContainerStartupProbeTcpSocket> getTcpSocket() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecContainerStartupProbe> {
        private java.util.List<imports.kubernetes.PodSpecContainerStartupProbeExec> exec;
        private java.lang.Number failureThreshold;
        private java.util.List<imports.kubernetes.PodSpecContainerStartupProbeHttpGet> httpGet;
        ...
        private java.util.List<imports.kubernetes.PodSpecContainerStartupProbeTcpSocket> tcpSocket;
        ...
        public Builder exec(java.util.List<? extends imports.kubernetes.PodSpecContainerStartupProbeExec> exec) {
            this.exec = (java.util.List<imports.kubernetes.PodSpecContainerStartupProbeExec>)exec;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder httpGet(java.util.List<? extends imports.kubernetes.PodSpecContainerStartupProbeHttpGet> httpGet) {
            this.httpGet = (java.util.List<imports.kubernetes.PodSpecContainerStartupProbeHttpGet>)httpGet;
            return this;
        }
        ...
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.PodSpecContainerStartupProbeTcpSocket> tcpSocket) {
            this.tcpSocket = (java.util.List<imports.kubernetes.PodSpecContainerStartupProbeTcpSocket>)tcpSocket;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecContainerStartupProbe {
        private final java.util.List<imports.kubernetes.PodSpecContainerStartupProbeExec> exec;
        private final java.lang.Number failureThreshold;
        private final java.util.List<imports.kubernetes.PodSpecContainerStartupProbeHttpGet> httpGet;
        ...
        private final java.util.List<imports.kubernetes.PodSpecContainerStartupProbeTcpSocket> tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecContainerStartupProbeExec.class)));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecContainerStartupProbeHttpGet.class)));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecContainerStartupProbeTcpSocket.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.PodSpecContainerStartupProbeExec> exec, final java.lang.Number failureThreshold, final java.util.List<? extends imports.kubernetes.PodSpecContainerStartupProbeHttpGet> httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final java.util.List<? extends imports.kubernetes.PodSpecContainerStartupProbeTcpSocket> tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecContainerStartupProbeExec> getExec() {
            return this.exec;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecContainerStartupProbeHttpGet> getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecContainerStartupProbeTcpSocket> getTcpSocket() {

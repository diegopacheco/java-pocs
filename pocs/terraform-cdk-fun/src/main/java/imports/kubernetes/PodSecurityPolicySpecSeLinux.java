...
public interface PodSecurityPolicySpecSeLinux extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityPolicySpecSeLinux> {
        ...
        private java.util.List<imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions> seLinuxOptions;
        ...
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions>)seLinuxOptions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicySpecSeLinux {
        ...
        private final java.util.List<imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String rule, final java.util.List<? extends imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions> seLinuxOptions) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSecurityPolicySpecSeLinuxSeLinuxOptions> getSeLinuxOptions() {

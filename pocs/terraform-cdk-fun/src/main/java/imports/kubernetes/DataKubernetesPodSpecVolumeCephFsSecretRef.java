...
public class DataKubernetesPodSpecVolumeCephFsSecretRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeCephFsSecretRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeCephFsSecretRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

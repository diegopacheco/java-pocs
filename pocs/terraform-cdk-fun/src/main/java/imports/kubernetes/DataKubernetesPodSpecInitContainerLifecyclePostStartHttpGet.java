...
public class DataKubernetesPodSpecInitContainerLifecyclePostStartHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLifecyclePostStartHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLifecyclePostStartHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesIngressLoadBalancerIngress")
public class DataKubernetesIngressLoadBalancerIngress extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesIngressLoadBalancerIngress(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesIngressLoadBalancerIngress(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

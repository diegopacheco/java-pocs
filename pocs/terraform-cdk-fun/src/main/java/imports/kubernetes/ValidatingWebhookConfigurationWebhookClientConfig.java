...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.965Z")
...
public interface ValidatingWebhookConfigurationWebhookClientConfig extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService> getService() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingWebhookConfigurationWebhookClientConfig> {
        ...
        private java.util.List<imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService> service;
        ...
        public Builder service(java.util.List<? extends imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService> service) {
            this.service = (java.util.List<imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService>)service;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhookConfigurationWebhookClientConfig {
        ...
        private final java.util.List<imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService> service;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.service = software.amazon.jsii.Kernel.get(this, "service", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String caBundle, final java.util.List<? extends imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService> service, final java.lang.String url) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ValidatingWebhookConfigurationWebhookClientConfigService> getService() {
            return this.service;
        }

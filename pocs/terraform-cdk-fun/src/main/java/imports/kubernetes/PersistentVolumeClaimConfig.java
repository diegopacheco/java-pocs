...
public interface PersistentVolumeClaimConfig extends software.amazon.jsii.JsiiSerializable, com.hashicorp.cdktf.TerraformMetaArguments {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.PersistentVolumeClaimMetadata> getMetadata();
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.PersistentVolumeClaimSpec> getSpec();
     ...
     */
    default @org.jetbrains.annotations.Nullable java.lang.Boolean getWaitUntilBound() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeClaimConfig> {
        private java.util.List<imports.kubernetes.PersistentVolumeClaimMetadata> metadata;
        private java.util.List<imports.kubernetes.PersistentVolumeClaimSpec> spec;
        private imports.kubernetes.PersistentVolumeClaimTimeouts timeouts;
        private java.lang.Boolean waitUntilBound;
        ...
        public Builder metadata(java.util.List<? extends imports.kubernetes.PersistentVolumeClaimMetadata> metadata) {
            this.metadata = (java.util.List<imports.kubernetes.PersistentVolumeClaimMetadata>)metadata;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder spec(java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpec> spec) {
            this.spec = (java.util.List<imports.kubernetes.PersistentVolumeClaimSpec>)spec;
            return this;
        }
        ...
        public PersistentVolumeClaimConfig build() {
            return new Jsii$Proxy(metadata, spec, timeouts, waitUntilBound, count, dependsOn, lifecycle, provider);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeClaimConfig {
        private final java.util.List<imports.kubernetes.PersistentVolumeClaimMetadata> metadata;
        private final java.util.List<imports.kubernetes.PersistentVolumeClaimSpec> spec;
        private final imports.kubernetes.PersistentVolumeClaimTimeouts timeouts;
        private final java.lang.Boolean waitUntilBound;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.metadata = software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PersistentVolumeClaimMetadata.class)));
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PersistentVolumeClaimSpec.class)));
            ...
            this.waitUntilBound = software.amazon.jsii.Kernel.get(this, "waitUntilBound", software.amazon.jsii.NativeType.forClass(java.lang.Boolean.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.PersistentVolumeClaimMetadata> metadata, final java.util.List<? extends imports.kubernetes.PersistentVolumeClaimSpec> spec, final imports.kubernetes.PersistentVolumeClaimTimeouts timeouts, final java.lang.Boolean waitUntilBound, final java.lang.Number count, final java.util.List<? extends com.hashicorp.cdktf.ITerraformDependable> dependsOn, final com.hashicorp.cdktf.TerraformResourceLifecycle lifecycle, final com.hashicorp.cdktf.TerraformProvider provider) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.metadata = (java.util.List<imports.kubernetes.PersistentVolumeClaimMetadata>)java.util.Objects.requireNonNull(metadata, "metadata is required");
            this.spec = (java.util.List<imports.kubernetes.PersistentVolumeClaimSpec>)java.util.Objects.requireNonNull(spec, "spec is required");
            this.timeouts = timeouts;
            this.waitUntilBound = waitUntilBound;
            this.count = count;
            this.dependsOn = (java.util.List<com.hashicorp.cdktf.ITerraformDependable>)dependsOn;
        ...
        @Override
        public final java.util.List<imports.kubernetes.PersistentVolumeClaimMetadata> getMetadata() {
            return this.metadata;
        }

        @Override
        public final java.util.List<imports.kubernetes.PersistentVolumeClaimSpec> getSpec() {
            return this.spec;
        }
        ...
        @Override
        public final java.lang.Boolean getWaitUntilBound() {

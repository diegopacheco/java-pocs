...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.755Z")
...
public interface PodSpecVolumeCephFs extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecVolumeCephFsSecretRef> getSecretRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecVolumeCephFs> {
        ...
        private java.util.List<imports.kubernetes.PodSpecVolumeCephFsSecretRef> secretRef;
        ...
        public Builder secretRef(java.util.List<? extends imports.kubernetes.PodSpecVolumeCephFsSecretRef> secretRef) {
            this.secretRef = (java.util.List<imports.kubernetes.PodSpecVolumeCephFsSecretRef>)secretRef;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecVolumeCephFs {
        ...
        private final java.util.List<imports.kubernetes.PodSpecVolumeCephFsSecretRef> secretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.secretRef = software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecVolumeCephFsSecretRef.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> monitors, final java.lang.String path, final java.lang.Boolean readOnly, final java.lang.String secretFile, final java.util.List<? extends imports.kubernetes.PodSpecVolumeCephFsSecretRef> secretRef, final java.lang.String user) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecVolumeCephFsSecretRef> getSecretRef() {

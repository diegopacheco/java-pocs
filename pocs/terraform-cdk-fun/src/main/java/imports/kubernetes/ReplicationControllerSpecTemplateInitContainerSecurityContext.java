...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateInitContainerSecurityContext.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateInitContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities> getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateInitContainerSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateInitContainerSecurityContext> {
        private java.lang.Boolean allowPrivilegeEscalation;
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities> capabilities;
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions> seLinuxOptions;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getCapabilities}
         * @param capabilities capabilities block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#capabilities ReplicationController#capabilities}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder capabilities(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities> capabilities) {
            this.capabilities = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities>)capabilities;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#se_linux_options ReplicationController#se_linux_options}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }

        /**
         * Builds the configured instance.
         * @return a new instance of {@link ReplicationControllerSpecTemplateInitContainerSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateInitContainerSecurityContext build() {
    ...
    /**
     * An implementation for {@link ReplicationControllerSpecTemplateInitContainerSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateInitContainerSecurityContext {
        private final java.lang.Boolean allowPrivilegeEscalation;
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities> capabilities;
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities.class)));
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Boolean allowPrivilegeEscalation, final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities> capabilities, final java.lang.Boolean privileged, final java.lang.Boolean readOnlyRootFilesystem, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextCapabilities> getCapabilities() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateInitContainerSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateInitContainerSecurityContext.Jsii$Proxy that = (ReplicationControllerSpecTemplateInitContainerSecurityContext.Jsii$Proxy) o;

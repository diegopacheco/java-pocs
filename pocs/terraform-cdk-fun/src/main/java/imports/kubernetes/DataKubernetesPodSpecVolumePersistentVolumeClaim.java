...
public class DataKubernetesPodSpecVolumePersistentVolumeClaim extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumePersistentVolumeClaim(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumePersistentVolumeClaim(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

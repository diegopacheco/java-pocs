...
public class DataKubernetesPodSpecInitContainerLivenessProbeExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLivenessProbeExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLivenessProbeExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

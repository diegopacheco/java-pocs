...
public class DataKubernetesPodSpecInitContainerLivenessProbeHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLivenessProbeHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLivenessProbeHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

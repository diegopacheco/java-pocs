...
public class DataKubernetesPodSpecInitContainerEnvValueFromConfigMapKeyRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvValueFromConfigMapKeyRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvValueFromConfigMapKeyRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

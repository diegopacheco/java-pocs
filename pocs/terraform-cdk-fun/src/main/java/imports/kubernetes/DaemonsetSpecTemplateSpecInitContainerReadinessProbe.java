...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.477Z")
...
public interface DaemonsetSpecTemplateSpecInitContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec> getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet> getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> getTcpSocket() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerReadinessProbe> {
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec> exec;
        private java.lang.Number failureThreshold;
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet> httpGet;
        ...
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> tcpSocket;
        ...
        public Builder exec(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec> exec) {
            this.exec = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec>)exec;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder httpGet(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet> httpGet) {
            this.httpGet = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet>)httpGet;
            return this;
        }
        ...
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket>)tcpSocket;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerReadinessProbe {
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec> exec;
        private final java.lang.Number failureThreshold;
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet> httpGet;
        ...
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec.class)));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet.class)));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec> exec, final java.lang.Number failureThreshold, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet> httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeExec> getExec() {
            return this.exec;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeHttpGet> getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerReadinessProbeTcpSocket> getTcpSocket() {

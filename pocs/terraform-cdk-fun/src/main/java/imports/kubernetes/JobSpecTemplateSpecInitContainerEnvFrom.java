...
public interface JobSpecTemplateSpecInitContainerEnvFrom extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef> getConfigMapRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef> getSecretRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecInitContainerEnvFrom> {
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef> configMapRef;
        private java.lang.String prefix;
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef> secretRef;
        ...
        public Builder configMapRef(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef> configMapRef) {
            this.configMapRef = (java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef>)configMapRef;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder secretRef(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef> secretRef) {
            this.secretRef = (java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef>)secretRef;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecInitContainerEnvFrom {
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef> configMapRef;
        private final java.lang.String prefix;
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef> secretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapRef = software.amazon.jsii.Kernel.get(this, "configMapRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef.class)));
            this.prefix = software.amazon.jsii.Kernel.get(this, "prefix", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
            this.secretRef = software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef> configMapRef, final java.lang.String prefix, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef> secretRef) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromConfigMapRef> getConfigMapRef() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvFromSecretRef> getSecretRef() {

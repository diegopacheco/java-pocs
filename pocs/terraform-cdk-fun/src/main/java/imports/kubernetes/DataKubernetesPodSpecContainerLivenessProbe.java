...
public class DataKubernetesPodSpecContainerLivenessProbe extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLivenessProbe(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLivenessProbe(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

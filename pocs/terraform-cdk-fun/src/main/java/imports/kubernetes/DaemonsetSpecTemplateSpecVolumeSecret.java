...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.500Z")
...
public interface DaemonsetSpecTemplateSpecVolumeSecret extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems> getItems() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecVolumeSecret> {
        ...
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems> items;
        ...
        public Builder items(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems> items) {
            this.items = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems>)items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecVolumeSecret {
        ...
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultMode, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems> items, final java.lang.Boolean optional, final java.lang.String secretName) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeSecretItems> getItems() {
            return this.items;
        }

...
public class DataKubernetesPodSpecInitContainerLifecyclePostStart extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLifecyclePostStart(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLifecyclePostStart(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.481Z")
...
public interface DaemonsetSpecTemplateSpecSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecSecurityContext> {
        ...
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecSecurityContext {
        ...
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions.class)));
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecSecurityContextSeLinuxOptions> getSeLinuxOptions() {

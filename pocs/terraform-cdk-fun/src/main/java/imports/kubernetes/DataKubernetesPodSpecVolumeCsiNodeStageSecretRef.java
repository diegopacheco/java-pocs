...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecVolumeCsiNodeStageSecretRef")
public class DataKubernetesPodSpecVolumeCsiNodeStageSecretRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeCsiNodeStageSecretRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeCsiNodeStageSecretRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

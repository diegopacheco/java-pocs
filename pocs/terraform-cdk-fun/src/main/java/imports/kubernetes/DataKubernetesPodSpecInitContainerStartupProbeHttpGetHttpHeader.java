...
public class DataKubernetesPodSpecInitContainerStartupProbeHttpGetHttpHeader extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerStartupProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerStartupProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

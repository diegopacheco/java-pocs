...
public interface JobSpecTemplateSpecVolumeDownwardApi extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems> getItems() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecVolumeDownwardApi> {
        ...
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems> items;
        ...
        public Builder items(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems> items) {
            this.items = (java.util.List<imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems>)items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecVolumeDownwardApi {
        ...
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultMode, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems> items) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecVolumeDownwardApiItems> getItems() {
            return this.items;
        }

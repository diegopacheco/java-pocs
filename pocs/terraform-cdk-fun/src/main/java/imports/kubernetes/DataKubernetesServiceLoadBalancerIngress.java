...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesServiceLoadBalancerIngress")
public class DataKubernetesServiceLoadBalancerIngress extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesServiceLoadBalancerIngress(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesServiceLoadBalancerIngress(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

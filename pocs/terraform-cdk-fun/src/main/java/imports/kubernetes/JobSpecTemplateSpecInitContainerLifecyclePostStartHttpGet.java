...
public interface JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGet extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader> getHttpHeader() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGet> {
        ...
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader> httpHeader;
        ...
        public Builder httpHeader(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader> httpHeader) {
            this.httpHeader = (java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader>)httpHeader;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGet {
        ...
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader> httpHeader;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.httpHeader = software.amazon.jsii.Kernel.get(this, "httpHeader", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String host, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader> httpHeader, final java.lang.String path, final java.lang.String port, final java.lang.String scheme) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerLifecyclePostStartHttpGetHttpHeader> getHttpHeader() {

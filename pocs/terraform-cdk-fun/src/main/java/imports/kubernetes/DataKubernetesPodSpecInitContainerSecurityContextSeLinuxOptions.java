...
public class DataKubernetesPodSpecInitContainerSecurityContextSeLinuxOptions extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerSecurityContextSeLinuxOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerSecurityContextSeLinuxOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecContainerStartupProbeExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerStartupProbeExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerStartupProbeExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecInitContainerLivenessProbeTcpSocket extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLivenessProbeTcpSocket(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLivenessProbeTcpSocket(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecInitContainerEnvValueFromResourceFieldRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvValueFromResourceFieldRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvValueFromResourceFieldRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public interface JobSpecTemplateSpecContainerReadinessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec> getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet> getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket> getTcpSocket() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecContainerReadinessProbe> {
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec> exec;
        private java.lang.Number failureThreshold;
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet> httpGet;
        ...
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket;
        ...
        public Builder exec(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec> exec) {
            this.exec = (java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec>)exec;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder httpGet(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet> httpGet) {
            this.httpGet = (java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet>)httpGet;
            return this;
        }
        ...
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = (java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket>)tcpSocket;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecContainerReadinessProbe {
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec> exec;
        private final java.lang.Number failureThreshold;
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet> httpGet;
        ...
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec.class)));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet.class)));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec> exec, final java.lang.Number failureThreshold, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet> httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket> tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeExec> getExec() {
            return this.exec;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeHttpGet> getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerReadinessProbeTcpSocket> getTcpSocket() {

...
public interface NetworkPolicySpecEgressToPodSelector extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions> getMatchExpressions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<NetworkPolicySpecEgressToPodSelector> {
        private java.util.List<imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions> matchExpressions;
        ...
        public Builder matchExpressions(java.util.List<? extends imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions> matchExpressions) {
            this.matchExpressions = (java.util.List<imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions>)matchExpressions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements NetworkPolicySpecEgressToPodSelector {
        private final java.util.List<imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions> matchExpressions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.matchExpressions = software.amazon.jsii.Kernel.get(this, "matchExpressions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions> matchExpressions, final java.util.Map<java.lang.String, java.lang.String> matchLabels) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.NetworkPolicySpecEgressToPodSelectorMatchExpressions> getMatchExpressions() {

...
public class DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvValueFromSecretKeyRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

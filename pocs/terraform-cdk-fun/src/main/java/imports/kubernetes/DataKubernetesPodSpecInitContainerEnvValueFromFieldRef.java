...
public class DataKubernetesPodSpecInitContainerEnvValueFromFieldRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvValueFromFieldRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvValueFromFieldRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ServiceLoadBalancerIngress")
public class ServiceLoadBalancerIngress extends com.hashicorp.cdktf.ComplexComputedList {

    protected ServiceLoadBalancerIngress(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected ServiceLoadBalancerIngress(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
    ...
    public ServiceLoadBalancerIngress(final @org.jetbrains.annotations.NotNull com.hashicorp.cdktf.ITerraformResource terraformResource, final @org.jetbrains.annotations.NotNull java.lang.String terraformAttribute, final @org.jetbrains.annotations.NotNull java.lang.String complexComputedListIndex) {

...
public interface PodSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecDnsConfigOption> getOption() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecDnsConfig> {
        ...
        private java.util.List<imports.kubernetes.PodSpecDnsConfigOption> option;
        ...
        public Builder option(java.util.List<? extends imports.kubernetes.PodSpecDnsConfigOption> option) {
            this.option = (java.util.List<imports.kubernetes.PodSpecDnsConfigOption>)option;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecDnsConfig {
        ...
        private final java.util.List<imports.kubernetes.PodSpecDnsConfigOption> option;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.option = software.amazon.jsii.Kernel.get(this, "option", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecDnsConfigOption.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> nameservers, final java.util.List<? extends imports.kubernetes.PodSpecDnsConfigOption> option, final java.util.List<java.lang.String> searches) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecDnsConfigOption> getOption() {
            return this.option;
        }

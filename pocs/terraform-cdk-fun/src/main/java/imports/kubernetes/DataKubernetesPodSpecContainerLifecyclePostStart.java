...
public class DataKubernetesPodSpecContainerLifecyclePostStart extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLifecyclePostStart(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLifecyclePostStart(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

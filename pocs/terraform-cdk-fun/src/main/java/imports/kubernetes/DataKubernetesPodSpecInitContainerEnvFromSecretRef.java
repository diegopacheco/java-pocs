...
public class DataKubernetesPodSpecInitContainerEnvFromSecretRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvFromSecretRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvFromSecretRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.485Z")
...
public interface DaemonsetSpecTemplateSpecVolumeCephFs extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef> getSecretRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecVolumeCephFs> {
        ...
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef> secretRef;
        ...
        public Builder secretRef(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef> secretRef) {
            this.secretRef = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef>)secretRef;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecVolumeCephFs {
        ...
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef> secretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.secretRef = software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> monitors, final java.lang.String path, final java.lang.Boolean readOnly, final java.lang.String secretFile, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef> secretRef, final java.lang.String user) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecVolumeCephFsSecretRef> getSecretRef() {

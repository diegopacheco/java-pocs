...
public interface StatefulSetSpecTemplateSpecVolumeSecret extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems> getItems() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecVolumeSecret> {
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems> items;
        ...
        public Builder items(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems> items) {
            this.items = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems>)items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecVolumeSecret {
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultMode, final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems> items, final java.lang.Boolean optional, final java.lang.String secretName) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeSecretItems> getItems() {
            return this.items;
        }

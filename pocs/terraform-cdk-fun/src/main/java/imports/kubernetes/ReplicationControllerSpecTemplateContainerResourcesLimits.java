...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateContainerResourcesLimits")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateContainerResourcesLimits.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateContainerResourcesLimits extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateContainerResourcesLimits}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateContainerResourcesLimits}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateContainerResourcesLimits> {
        private java.lang.String cpu;
        private java.lang.String memory;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerResourcesLimits#getCpu}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerResourcesLimits#getMemory}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateContainerResourcesLimits}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateContainerResourcesLimits build() {
            return new Jsii$Proxy(cpu, memory);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateContainerResourcesLimits}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateContainerResourcesLimits {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateContainerResourcesLimits"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateContainerResourcesLimits.Jsii$Proxy that = (ReplicationControllerSpecTemplateContainerResourcesLimits.Jsii$Proxy) o;

...
public class DataKubernetesPodSpecContainerReadinessProbeHttpGetHttpHeader extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerReadinessProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerReadinessProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateVolumeGitRepo")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateVolumeGitRepo.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateVolumeGitRepo extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateVolumeGitRepo}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateVolumeGitRepo}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateVolumeGitRepo> {
        private java.lang.String directory;
        private java.lang.String repository;
        private java.lang.String revision;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeGitRepo#getDirectory}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeGitRepo#getRepository}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateVolumeGitRepo#getRevision}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateVolumeGitRepo}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateVolumeGitRepo build() {
            return new Jsii$Proxy(directory, repository, revision);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateVolumeGitRepo}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateVolumeGitRepo {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateVolumeGitRepo"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateVolumeGitRepo.Jsii$Proxy that = (ReplicationControllerSpecTemplateVolumeGitRepo.Jsii$Proxy) o;

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.780Z")
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbe")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateContainerLivenessProbe.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateContainerLivenessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec> getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet> getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket> getTcpSocket() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateContainerLivenessProbe}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateContainerLivenessProbe}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateContainerLivenessProbe> {
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec> exec;
        private java.lang.Number failureThreshold;
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet> httpGet;
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket> tcpSocket;
        private java.lang.Number timeoutSeconds;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getExec}
         * @param exec exec block.
         *             Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#exec ReplicationController#exec}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder exec(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec> exec) {
            this.exec = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec>)exec;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getFailureThreshold}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getHttpGet}
         * @param httpGet http_get block.
         *                Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#http_get ReplicationController#http_get}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder httpGet(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet> httpGet) {
            this.httpGet = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet>)httpGet;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getInitialDelaySeconds}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getPeriodSeconds}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getSuccessThreshold}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getTcpSocket}
         * @param tcpSocket tcp_socket block.
         *                  Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#tcp_socket ReplicationController#tcp_socket}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket>)tcpSocket;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerLivenessProbe#getTimeoutSeconds}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateContainerLivenessProbe}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateContainerLivenessProbe build() {
    ...
    /**
     * An implementation for {@link ReplicationControllerSpecTemplateContainerLivenessProbe}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateContainerLivenessProbe {
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec> exec;
        private final java.lang.Number failureThreshold;
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet> httpGet;
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket> tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec.class)));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet.class)));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec> exec, final java.lang.Number failureThreshold, final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet> httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket> tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeExec> getExec() {
            return this.exec;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeHttpGet> getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbeTcpSocket> getTcpSocket() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateContainerLivenessProbe"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateContainerLivenessProbe.Jsii$Proxy that = (ReplicationControllerSpecTemplateContainerLivenessProbe.Jsii$Proxy) o;

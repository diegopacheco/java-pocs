...
public class DataKubernetesPodSpecContainerLifecycle extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLifecycle(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLifecycle(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecInitContainerEnvFromConfigMapRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvFromConfigMapRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvFromConfigMapRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

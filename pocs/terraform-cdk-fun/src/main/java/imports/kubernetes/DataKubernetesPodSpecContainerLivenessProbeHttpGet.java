...
public class DataKubernetesPodSpecContainerLivenessProbeHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLivenessProbeHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLivenessProbeHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

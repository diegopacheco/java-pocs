...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.933Z")
...
public interface StatefulSetSpecTemplateSpecContainerStartupProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec> getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet> getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket> getTcpSocket() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecContainerStartupProbe> {
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec> exec;
        private java.lang.Number failureThreshold;
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet> httpGet;
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket> tcpSocket;
        ...
        public Builder exec(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec> exec) {
            this.exec = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec>)exec;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder httpGet(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet> httpGet) {
            this.httpGet = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet>)httpGet;
            return this;
        }
        ...
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket> tcpSocket) {
            this.tcpSocket = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket>)tcpSocket;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecContainerStartupProbe {
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec> exec;
        private final java.lang.Number failureThreshold;
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet> httpGet;
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket> tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec.class)));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet.class)));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec> exec, final java.lang.Number failureThreshold, final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet> httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket> tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeExec> getExec() {
            return this.exec;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeHttpGet> getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecContainerStartupProbeTcpSocket> getTcpSocket() {

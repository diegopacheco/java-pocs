...
public interface StatefulSetSpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> getOption() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecDnsConfig> {
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> option;
        ...
        public Builder option(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> option) {
            this.option = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption>)option;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecDnsConfig {
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> option;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.option = software.amazon.jsii.Kernel.get(this, "option", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> nameservers, final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> option, final java.util.List<java.lang.String> searches) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecDnsConfigOption> getOption() {
            return this.option;
        }

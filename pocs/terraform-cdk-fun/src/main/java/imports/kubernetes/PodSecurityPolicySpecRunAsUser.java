...
public interface PodSecurityPolicySpecRunAsUser extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSecurityPolicySpecRunAsUserRange> getRange() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityPolicySpecRunAsUser> {
        ...
        private java.util.List<imports.kubernetes.PodSecurityPolicySpecRunAsUserRange> range;
        ...
        public Builder range(java.util.List<? extends imports.kubernetes.PodSecurityPolicySpecRunAsUserRange> range) {
            this.range = (java.util.List<imports.kubernetes.PodSecurityPolicySpecRunAsUserRange>)range;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicySpecRunAsUser {
        ...
        private final java.util.List<imports.kubernetes.PodSecurityPolicySpecRunAsUserRange> range;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.range = software.amazon.jsii.Kernel.get(this, "range", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSecurityPolicySpecRunAsUserRange.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String rule, final java.util.List<? extends imports.kubernetes.PodSecurityPolicySpecRunAsUserRange> range) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSecurityPolicySpecRunAsUserRange> getRange() {
            return this.range;
        }

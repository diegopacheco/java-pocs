...
public class DataKubernetesPodSpecVolumeConfigMapItems extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeConfigMapItems(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeConfigMapItems(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

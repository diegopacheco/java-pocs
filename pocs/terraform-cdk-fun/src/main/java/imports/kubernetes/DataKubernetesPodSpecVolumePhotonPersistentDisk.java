...
public class DataKubernetesPodSpecVolumePhotonPersistentDisk extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumePhotonPersistentDisk(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumePhotonPersistentDisk(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.726Z")
...
public interface PodSpecContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecContainerSecurityContextCapabilities> getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSpecContainerSecurityContext> {
        ...
        private java.util.List<imports.kubernetes.PodSpecContainerSecurityContextCapabilities> capabilities;
        ...
        private java.util.List<imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        public Builder capabilities(java.util.List<? extends imports.kubernetes.PodSpecContainerSecurityContextCapabilities> capabilities) {
            this.capabilities = (java.util.List<imports.kubernetes.PodSpecContainerSecurityContextCapabilities>)capabilities;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSpecContainerSecurityContext {
        ...
        private final java.util.List<imports.kubernetes.PodSpecContainerSecurityContextCapabilities> capabilities;
        ...
        private final java.util.List<imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecContainerSecurityContextCapabilities.class)));
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.Boolean allowPrivilegeEscalation, final java.util.List<? extends imports.kubernetes.PodSpecContainerSecurityContextCapabilities> capabilities, final java.lang.Boolean privileged, final java.lang.Boolean readOnlyRootFilesystem, final java.lang.Number runAsGroup, final java.lang.Boolean runAsNonRoot, final java.lang.Number runAsUser, final java.util.List<? extends imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecContainerSecurityContextCapabilities> getCapabilities() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.PodSpecContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {

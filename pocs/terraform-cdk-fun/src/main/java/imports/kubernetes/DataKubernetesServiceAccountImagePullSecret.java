...
public class DataKubernetesServiceAccountImagePullSecret extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesServiceAccountImagePullSecret(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesServiceAccountImagePullSecret(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

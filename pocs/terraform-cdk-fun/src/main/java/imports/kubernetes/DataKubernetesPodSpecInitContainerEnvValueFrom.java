...
public class DataKubernetesPodSpecInitContainerEnvValueFrom extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerEnvValueFrom(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerEnvValueFrom(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

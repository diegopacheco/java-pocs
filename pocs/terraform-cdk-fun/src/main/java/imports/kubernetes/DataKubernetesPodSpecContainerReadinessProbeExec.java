...
public class DataKubernetesPodSpecContainerReadinessProbeExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerReadinessProbeExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerReadinessProbeExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

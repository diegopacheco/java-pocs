...
public class DataKubernetesPodSpecContainerStartupProbeHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerStartupProbeHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerStartupProbeHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.944Z")
...
public interface StatefulSetSpecTemplateSpecInitContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities> getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecInitContainerSecurityContext> {
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities> capabilities;
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        public Builder capabilities(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities> capabilities) {
            this.capabilities = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities>)capabilities;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecInitContainerSecurityContext {
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities> capabilities;
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities.class)));
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions.class)));
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextCapabilities> getCapabilities() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecInitContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {

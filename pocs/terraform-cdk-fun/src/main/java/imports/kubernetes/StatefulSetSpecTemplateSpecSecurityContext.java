...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.946Z")
...
public interface StatefulSetSpecTemplateSpecSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecSecurityContext> {
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecSecurityContext {
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions.class)));
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecSecurityContextSeLinuxOptions> getSeLinuxOptions() {

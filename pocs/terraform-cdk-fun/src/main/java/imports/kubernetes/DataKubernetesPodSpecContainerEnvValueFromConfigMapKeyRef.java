...
public class DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerEnvValueFromConfigMapKeyRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecContainerReadinessProbeHttpGet extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerReadinessProbeHttpGet(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerReadinessProbeHttpGet(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

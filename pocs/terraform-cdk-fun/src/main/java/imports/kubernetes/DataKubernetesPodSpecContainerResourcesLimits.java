...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecContainerResourcesLimits")
public class DataKubernetesPodSpecContainerResourcesLimits extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerResourcesLimits(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerResourcesLimits(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecContainerLifecyclePreStopExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLifecyclePreStopExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLifecyclePreStopExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

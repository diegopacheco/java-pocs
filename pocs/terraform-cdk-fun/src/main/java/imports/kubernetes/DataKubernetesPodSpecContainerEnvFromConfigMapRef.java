...
public class DataKubernetesPodSpecContainerEnvFromConfigMapRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerEnvFromConfigMapRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerEnvFromConfigMapRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

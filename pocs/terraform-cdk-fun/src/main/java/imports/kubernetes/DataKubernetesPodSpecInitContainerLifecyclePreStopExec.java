...
public class DataKubernetesPodSpecInitContainerLifecyclePreStopExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLifecyclePreStopExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLifecyclePreStopExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecVolumeFlexVolumeSecretRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeFlexVolumeSecretRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeFlexVolumeSecretRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

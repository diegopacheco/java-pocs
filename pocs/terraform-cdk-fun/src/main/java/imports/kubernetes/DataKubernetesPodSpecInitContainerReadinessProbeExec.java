...
public class DataKubernetesPodSpecInitContainerReadinessProbeExec extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerReadinessProbeExec(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerReadinessProbeExec(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public class DataKubernetesPodSpecVolumeVsphereVolume extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeVsphereVolume(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeVsphereVolume(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
public interface StatefulSetSpecTemplateSpecVolumeConfigMap extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems> getItems() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpecTemplateSpecVolumeConfigMap> {
        ...
        private java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems> items;
        ...
        public Builder items(java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems> items) {
            this.items = (java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems>)items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpecTemplateSpecVolumeConfigMap {
        ...
        private final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String defaultMode, final java.util.List<? extends imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems> items, final java.lang.String name, final java.lang.Boolean optional) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.StatefulSetSpecTemplateSpecVolumeConfigMapItems> getItems() {
            return this.items;
        }

...
@javax.annotation.Generated(value = "jsii-pacmak/1.30.0 (build adae23f)", date = "2021-06-16T06:12:12.476Z")
...
public interface DaemonsetSpecTemplateSpecInitContainerLivenessProbe extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec> getExec() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet> getHttpGet() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> getTcpSocket() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<DaemonsetSpecTemplateSpecInitContainerLivenessProbe> {
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec> exec;
        private java.lang.Number failureThreshold;
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet> httpGet;
        ...
        private java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> tcpSocket;
        ...
        public Builder exec(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec> exec) {
            this.exec = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec>)exec;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder httpGet(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet> httpGet) {
            this.httpGet = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet>)httpGet;
            return this;
        }
        ...
        public Builder tcpSocket(java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> tcpSocket) {
            this.tcpSocket = (java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket>)tcpSocket;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements DaemonsetSpecTemplateSpecInitContainerLivenessProbe {
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec> exec;
        private final java.lang.Number failureThreshold;
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet> httpGet;
        ...
        private final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> tcpSocket;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.exec = software.amazon.jsii.Kernel.get(this, "exec", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec.class)));
            ...
            this.httpGet = software.amazon.jsii.Kernel.get(this, "httpGet", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet.class)));
            ...
            this.tcpSocket = software.amazon.jsii.Kernel.get(this, "tcpSocket", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec> exec, final java.lang.Number failureThreshold, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet> httpGet, final java.lang.Number initialDelaySeconds, final java.lang.Number periodSeconds, final java.lang.Number successThreshold, final java.util.List<? extends imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> tcpSocket, final java.lang.Number timeoutSeconds) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeExec> getExec() {
            return this.exec;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeHttpGet> getHttpGet() {
            return this.httpGet;
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.DaemonsetSpecTemplateSpecInitContainerLivenessProbeTcpSocket> getTcpSocket() {

...
public class DataKubernetesPodSpecContainerEnvValueFromFieldRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerEnvValueFromFieldRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerEnvValueFromFieldRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

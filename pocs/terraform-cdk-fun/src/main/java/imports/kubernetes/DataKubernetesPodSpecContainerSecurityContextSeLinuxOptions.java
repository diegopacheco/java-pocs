...
public class DataKubernetesPodSpecContainerSecurityContextSeLinuxOptions extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerSecurityContextSeLinuxOptions(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerSecurityContextSeLinuxOptions(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

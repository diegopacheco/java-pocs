...
public class DataKubernetesPodSpecContainerEnvValueFromResourceFieldRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerEnvValueFromResourceFieldRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerEnvValueFromResourceFieldRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecVolumeCsiControllerExpandSecretRef")
public class DataKubernetesPodSpecVolumeCsiControllerExpandSecretRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeCsiControllerExpandSecretRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeCsiControllerExpandSecretRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

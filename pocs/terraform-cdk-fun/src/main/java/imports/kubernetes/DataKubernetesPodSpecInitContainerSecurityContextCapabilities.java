...
public class DataKubernetesPodSpecInitContainerSecurityContextCapabilities extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerSecurityContextCapabilities(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerSecurityContextCapabilities(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

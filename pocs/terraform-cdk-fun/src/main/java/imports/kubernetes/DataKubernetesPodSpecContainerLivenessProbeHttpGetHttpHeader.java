...
public class DataKubernetesPodSpecContainerLivenessProbeHttpGetHttpHeader extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecContainerLivenessProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecContainerLivenessProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

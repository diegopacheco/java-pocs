...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateHostAliases")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateHostAliases.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateHostAliases extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateHostAliases}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateHostAliases}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateHostAliases> {
        private java.util.List<java.lang.String> hostnames;
        private java.lang.String ip;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateHostAliases#getHostnames}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateHostAliases#getIp}
         ...
         * @return a new instance of {@link ReplicationControllerSpecTemplateHostAliases}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateHostAliases build() {
            return new Jsii$Proxy(hostnames, ip);
        }
    }

    /**
     * An implementation for {@link ReplicationControllerSpecTemplateHostAliases}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateHostAliases {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateHostAliases"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateHostAliases.Jsii$Proxy that = (ReplicationControllerSpecTemplateHostAliases.Jsii$Proxy) o;

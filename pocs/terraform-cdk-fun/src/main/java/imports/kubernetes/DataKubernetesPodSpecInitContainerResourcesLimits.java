...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecInitContainerResourcesLimits")
public class DataKubernetesPodSpecInitContainerResourcesLimits extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerResourcesLimits(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerResourcesLimits(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

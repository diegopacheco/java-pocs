...
public interface ReplicationControllerSpecTemplateSpecDnsConfig extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption> getOption() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateSpecDnsConfig> {
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption> option;
        ...
        public Builder option(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption> option) {
            this.option = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption>)option;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateSpecDnsConfig {
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption> option;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.option = software.amazon.jsii.Kernel.get(this, "option", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<java.lang.String> nameservers, final java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption> option, final java.util.List<java.lang.String> searches) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateSpecDnsConfigOption> getOption() {
            return this.option;
        }

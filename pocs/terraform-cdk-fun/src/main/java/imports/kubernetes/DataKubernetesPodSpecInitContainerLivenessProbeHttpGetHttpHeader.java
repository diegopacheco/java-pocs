...
public class DataKubernetesPodSpecInitContainerLivenessProbeHttpGetHttpHeader extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLivenessProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLivenessProbeHttpGetHttpHeader(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

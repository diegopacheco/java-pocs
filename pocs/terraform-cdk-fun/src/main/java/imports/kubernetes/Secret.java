...
public class Secret extends com.hashicorp.cdktf.TerraformResource {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.SecretMetadata> getMetadataInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.SecretMetadata.class))));
    }
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.SecretMetadata> getMetadata() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.SecretMetadata.class))));
    }

    public void setMetadata(final @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.SecretMetadata> value) {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.Secret> {
         ...
         */
        public Builder metadata(final java.util.List<? extends imports.kubernetes.SecretMetadata> metadata) {

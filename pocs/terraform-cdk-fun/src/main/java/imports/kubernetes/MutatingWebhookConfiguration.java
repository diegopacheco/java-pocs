...
public class MutatingWebhookConfiguration extends com.hashicorp.cdktf.TerraformResource {
    ...
    public @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.MutatingWebhookConfigurationMetadata> getMetadataInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "metadataInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.MutatingWebhookConfigurationMetadata.class))));
    }

    public @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.MutatingWebhookConfigurationWebhook> getWebhookInput() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "webhookInput", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.MutatingWebhookConfigurationWebhook.class))));
    }

    public @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.MutatingWebhookConfigurationMetadata> getMetadata() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "metadata", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.MutatingWebhookConfigurationMetadata.class))));
    }

    public void setMetadata(final @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.MutatingWebhookConfigurationMetadata> value) {
        software.amazon.jsii.Kernel.set(this, "metadata", java.util.Objects.requireNonNull(value, "metadata is required"));
    }

    public @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.MutatingWebhookConfigurationWebhook> getWebhook() {
        return java.util.Collections.unmodifiableList(software.amazon.jsii.Kernel.get(this, "webhook", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.MutatingWebhookConfigurationWebhook.class))));
    }

    public void setWebhook(final @org.jetbrains.annotations.NotNull java.util.List<imports.kubernetes.MutatingWebhookConfigurationWebhook> value) {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.kubernetes.MutatingWebhookConfiguration> {
         ...
         */
        public Builder metadata(final java.util.List<? extends imports.kubernetes.MutatingWebhookConfigurationMetadata> metadata) {

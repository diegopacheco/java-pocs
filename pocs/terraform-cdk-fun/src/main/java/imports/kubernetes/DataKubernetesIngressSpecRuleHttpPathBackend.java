...
public class DataKubernetesIngressSpecRuleHttpPathBackend extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesIngressSpecRuleHttpPathBackend(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesIngressSpecRuleHttpPathBackend(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

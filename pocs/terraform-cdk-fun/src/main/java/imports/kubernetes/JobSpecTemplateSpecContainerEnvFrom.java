...
public interface JobSpecTemplateSpecContainerEnvFrom extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef> getConfigMapRef() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef> getSecretRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecContainerEnvFrom> {
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef> configMapRef;
        private java.lang.String prefix;
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef> secretRef;
        ...
        public Builder configMapRef(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef> configMapRef) {
            this.configMapRef = (java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef>)configMapRef;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder secretRef(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef> secretRef) {
            this.secretRef = (java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef>)secretRef;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecContainerEnvFrom {
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef> configMapRef;
        private final java.lang.String prefix;
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef> secretRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.configMapRef = software.amazon.jsii.Kernel.get(this, "configMapRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef.class)));
            this.prefix = software.amazon.jsii.Kernel.get(this, "prefix", software.amazon.jsii.NativeType.forClass(java.lang.String.class));
            this.secretRef = software.amazon.jsii.Kernel.get(this, "secretRef", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef> configMapRef, final java.lang.String prefix, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef> secretRef) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromConfigMapRef> getConfigMapRef() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecContainerEnvFromSecretRef> getSecretRef() {

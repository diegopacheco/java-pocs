...
public class DataKubernetesPodSpecInitContainerLifecyclePostStartHttpGetHttpHeader extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecInitContainerLifecyclePostStartHttpGetHttpHeader(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecInitContainerLifecyclePostStartHttpGetHttpHeader(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.DataKubernetesPodSpecVolumeCsiControllerPublishSecretRef")
public class DataKubernetesPodSpecVolumeCsiControllerPublishSecretRef extends com.hashicorp.cdktf.ComplexComputedList {

    protected DataKubernetesPodSpecVolumeCsiControllerPublishSecretRef(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected DataKubernetesPodSpecVolumeCsiControllerPublishSecretRef(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {

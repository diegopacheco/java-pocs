...
public interface JobSpecTemplateSpecInitContainerEnv extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom> getValueFrom() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<JobSpecTemplateSpecInitContainerEnv> {
        ...
        private java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom> valueFrom;
        ...
        public Builder valueFrom(java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom> valueFrom) {
            this.valueFrom = (java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom>)valueFrom;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements JobSpecTemplateSpecInitContainerEnv {
        ...
        private final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom> valueFrom;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.valueFrom = software.amazon.jsii.Kernel.get(this, "valueFrom", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom.class)));
        }
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.lang.String name, final java.lang.String value, final java.util.List<? extends imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom> valueFrom) {
        ...
        @Override
        public final java.util.List<imports.kubernetes.JobSpecTemplateSpecInitContainerEnvValueFrom> getValueFrom() {

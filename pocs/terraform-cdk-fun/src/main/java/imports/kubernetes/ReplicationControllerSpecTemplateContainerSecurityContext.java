...
@software.amazon.jsii.Jsii(module = imports.kubernetes.$Module.class, fqn = "kubernetes.ReplicationControllerSpecTemplateContainerSecurityContext")
@software.amazon.jsii.Jsii.Proxy(ReplicationControllerSpecTemplateContainerSecurityContext.Jsii$Proxy.class)
public interface ReplicationControllerSpecTemplateContainerSecurityContext extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities> getCapabilities() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        return null;
    }

    /**
     * @return a {@link Builder} of {@link ReplicationControllerSpecTemplateContainerSecurityContext}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link ReplicationControllerSpecTemplateContainerSecurityContext}
     */
    public static final class Builder implements software.amazon.jsii.Builder<ReplicationControllerSpecTemplateContainerSecurityContext> {
        private java.lang.Boolean allowPrivilegeEscalation;
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities> capabilities;
        ...
        private java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions> seLinuxOptions;

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getAllowPrivilegeEscalation}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getCapabilities}
         * @param capabilities capabilities block.
         *                     Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#capabilities ReplicationController#capabilities}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder capabilities(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities> capabilities) {
            this.capabilities = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities>)capabilities;
            return this;
        }

        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getPrivileged}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getReadOnlyRootFilesystem}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getRunAsGroup}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getRunAsNonRoot}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getRunAsUser}
        ...
        /**
         * Sets the value of {@link ReplicationControllerSpecTemplateContainerSecurityContext#getSeLinuxOptions}
         * @param seLinuxOptions se_linux_options block.
         *                       Docs at Terraform Registry: {&#64;link https://www.terraform.io/docs/providers/kubernetes/r/replication_controller.html#se_linux_options ReplicationController#se_linux_options}
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder seLinuxOptions(java.util.List<? extends imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions> seLinuxOptions) {
            this.seLinuxOptions = (java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions>)seLinuxOptions;
            return this;
        }

        /**
         * Builds the configured instance.
         * @return a new instance of {@link ReplicationControllerSpecTemplateContainerSecurityContext}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public ReplicationControllerSpecTemplateContainerSecurityContext build() {
    ...
    /**
     * An implementation for {@link ReplicationControllerSpecTemplateContainerSecurityContext}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ReplicationControllerSpecTemplateContainerSecurityContext {
        private final java.lang.Boolean allowPrivilegeEscalation;
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities> capabilities;
        ...
        private final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions> seLinuxOptions;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.capabilities = software.amazon.jsii.Kernel.get(this, "capabilities", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities.class)));
            ...
            this.seLinuxOptions = software.amazon.jsii.Kernel.get(this, "seLinuxOptions", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions.class)));
        }
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextCapabilities> getCapabilities() {
        ...
        @Override
        public final java.util.List<imports.kubernetes.ReplicationControllerSpecTemplateContainerSecurityContextSeLinuxOptions> getSeLinuxOptions() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("kubernetes.ReplicationControllerSpecTemplateContainerSecurityContext"));
        ...
        public final boolean equals(final Object o) {
            ...
            ReplicationControllerSpecTemplateContainerSecurityContext.Jsii$Proxy that = (ReplicationControllerSpecTemplateContainerSecurityContext.Jsii$Proxy) o;
